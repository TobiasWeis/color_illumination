...
if __name__=="__main__":
    ...
    cv2.imshow("max_white", max_white(img))
    cv2.imshow("retinex adjust", retinex_adjust(img))
    cv2.imshow("standard deviation weighted", standard_deviation_weighted_grey_world(img,50,50))
